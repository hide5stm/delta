...
pub struct Opt {
    ...
    /// Style for the commit hash decoration. Available attributes are 'box', and 'underline'.
    ...
    /// Style for the file decoration. Available attributes are 'box', and 'underline'.
    ...
    /// Style (foreground, background, attributes) for the hunk-header decoration. Available
    /// attributes are 'box', and 'underline'.
